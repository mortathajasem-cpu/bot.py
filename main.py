...
# ---------------------------------------------------------
# لقد وضعت لك التوكن الخاص بك هنا جاهزاً
...
def show_result(chat_id):
    ...
    if score <= 50: res = "شخصية تحتاج لتعزيز الثقة، تميل للهدوء وتجنب المشاكل."
    elif score <= 90: res = "شخصية طيبة ومتوازنة، لكن تتردد في المواقف الحاسمة."
    elif score <= 120: res = "شخصية قوية، مثقفة، ولديك طموح عالٍ."
    else: res = "شخصية قيادية فذة، كاريزما عالية، وشجاعة نادرة."
    
    bot.send_message(chat_id, f"✅ النتيجة النهائية:\nمجموع نقاطك: {score}\n\nتحليلنا:\n{res}")
